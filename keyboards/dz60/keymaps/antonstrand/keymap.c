...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
      ...
      KC_LCTL, KC_LALT, KC_LGUI, LT(MOUSE, KC_BSPC),  LT(ARROW, KC_SPC), KC_SPC, KC_RALT, TG(RGB), KC_LEFT, KC_DOWN, KC_RIGHT
      ),
   ...
   * |-----------------------------------------------------------------------------------------+
   * |       |     |     | Enter | Del | Find | Cut | Copy | Undo | Paste |    |    |    |     |
   * |-----------------------------------------------------------------------------------------+
  ...
  LAYOUT_all(
      ...
      ______, ______, ______, KC_ENT, KC_DEL, CK_FIND, CK_COPY, CK_UNDO, CK_PASTE, ______, ______, ______, ______, ______,

      ______, ______, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ______, ______, ______,

      ______, ______, CK_UNDO, CK_CUT, CK_COPY, CK_PASTE, KC_ESC, KC_ENT, ______, ______, ______, ______, ______, KC_VOLU, KC_MUTE,
   ...
   * | Esc |  F1 |  F2 |  F3 |  F4 |  F5 |  F6 |  F7 |  F8 |  F9 | F10 | F11 | F12 |   DEL     |
   * |-----------------------------------------------------------------------------------------+
   * |       |     | Spd 1 | Spd 2 | Spd 3 |  | Scrl L | Scrl U | Scrl D | Scrl R |  |  |  |   |
   * |-----------------------------------------------------------------------------------------+
   * |         |     |     |     | LBtn | RBtn | Left | Down |  Up | Right |    |    |         |
   * |-----------------------------------------------------------------------------------------+
   * |           |     |   |   |   |   |   |  | Scrl Up |     |    | LBtn | Up | RBtn |
   * |-----------------------------------------------------------------------------------------+
   * |      |       |       |                                   |    |    | Left | Down| Right |
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  LAYOUT_all(
      ...
      ______, ______, KC_ACL0, KC_ACL1, KC_ACL2, ______, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, ______, ______, ______, ______,

      ______, ______, ______, ______, KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, ______, ______, ______,

      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_BTN1, KC_MS_U, KC_BTN2,

      ______, ______, ______, ______, ______, ______, ______, ______, KC_MS_L, KC_MS_D, KC_MS_U
      ),
